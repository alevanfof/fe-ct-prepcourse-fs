...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   let totalLikes = 0; // Variable para almacenar la suma de los likes

   // Recorre cada post en el arreglo de posts
   for (let i = 0; i < objetoUsuario.posts.length; i++) {
      // Suma los likes del post actual al total de likes
      totalLikes += objetoUsuario.posts[i].likes;
   }

   return totalLikes; // Devuelve la suma total de likes
